...
<template>
  <div>
    <div class="bgWay">
      <div class="max-w-screen-xl  container lg:mx-auto !pt-[126px] !pb-[100px] relative">
        ...
        <div
            class="md:absolute md:left-1/2 md:transform md:-translate-x-1/2 md:-translate-y-1/2  md:bottom-[-60%] md:w-full">
...
.bgWay {
  ...
  background-image: url("@/assets/images/bgWay.jpg");
