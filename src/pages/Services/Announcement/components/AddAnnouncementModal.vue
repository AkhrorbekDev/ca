...
<template>
  <Dialog v-model:visible="model" modal :style="{ width: '50rem' }"
    ...
    <div>
      ...
      <div>
        <div
            v-if="announceValue.unique === 'delivery' || announceValue.unique === 'shipping' || announceValue.unique === 'passenger'">
          <div class="grid grid-cols-2 gap-4">
            ...
            <FloatLabel variant="in">
              ...
              <label for="in_label"
                     class="!text-[#292D324D]">{{
                  announceValue.unique === 'passenger' ? 'Maksimal yo‘lovchi soni' : 'Maksimal yuk sig‘imi'
                }}</label>
            </FloatLabel>
