...
<template>
  <div>
    ...
    <div class="relative z-50">
      <div class="flex items-center gap-4 bg-white !p-[16px] rounded-[40px]">
        <div class="w-[22%]">
        ...
        <div class="w-[22%]">
          ...
          <div
              class="w-full !bg-[#FAFAFA] !border-0 !rounded-[24px] h-[76px] !px-[16px] !pt-[12px] cursor-pointer">
            ...
            <div class="bg-white rounded-[24px] !p-[16px]" style="box-shadow: 0px 32px 100px 0px #292D3229;">
