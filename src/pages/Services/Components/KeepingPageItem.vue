...
<template>
  <div class="max-w-screen-xl lg:mx-auto relative">
    ...
    <div class="flex flex-col lg:flex-row bg-gray-50">
      ...
      <!--          <img src="@/assets/images/sklad-item.png" alt="#" class="rounded-lg object-cover"/>-->
      <!--        </div>-->

      <!--        <div class="flex w-[100%] !mt-[24px] justify-between items-center overflow-auto">-->
      <!--          <img v-for="(index) in 5" :key="index"-->
      <!--               src="@/assets/images/sklad-item.png"-->
      <!--               alt="Thumbnail 1"-->
      ...
      <div class="flex flex-col items-center">
        <div class="w-[684px] h-[600px] rounded-xl overflow-hidden">
          ...
          >
            <swiper-slide
            ><img
                src="@/assets/images/sklad-item.png"/></swiper-slide
            >
      ...
      <div class="flex flex-col md:!ml-[100px] lg:w-1/2">
        ...
        <span class="text-[#292D32] text-[48px] font-medium !mb-[40px]">800 000 UZS</span>
