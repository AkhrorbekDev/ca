...
<template>
  <div
      class="bg-[#FFFFFF] dark:!bg-zinc-700 rounded-[24px] overflow-hidden cursor-pointer"
    ...
    <div class="!px-[16px] !py-[12px] !bg-transparent">
      <div class="flex items-center justify-between !mb-[8px] !bg-transparent">
        <span class="text-[#000000]">{{ advertisement.service_name }}</span>
        <span class="text-[#000000] text-[16px] font-medium">{{ formatNumber(advertisement.price) }} UZS</span>
      </div>
      <p class="text-[#292D324D] text-[12px] !mb-1 !mt-auto">Maydon: {{ advertisement.details.area }} m2</p>

      <div
          class="flex items-center gap-2 text-[#292D324D] text-[12px] !mb-[12px]  whitespace-nowrap overflow-hidden text-ellipsis !bg-transparent dark:!text-[#B7B8BA]">
      ...
      <div class="flex items-center gap-4 !bg-transparent">
        <div class="flex items-center gap-1 text-[#000000] dark:!text-white text-[12px] !bg-transparent">
        ...
        <AvatarGroup>
          <Avatar
              ...
              shape="circle"
              class="bg-[#F3F3F3] dark:!bg-zinc-700 !text-[#B7B8BA] !h-[24px] !w-[24px]" alt="avatar"
          ...
          <Avatar v-if="advertisement.commenst?.length > 4" :label="`+${advertisement.comments.length}`" shape="circle"
                  class="!h-[24px] !w-[24px] !text-[8px] !bg-transparent !text-[#1A1F23]"/>
        </AvatarGroup>
      </div>
    </div>
  </div>
