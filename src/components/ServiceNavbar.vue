...
const openChildMenu = (index: number, item: MenuItems) => {
  console.log('test onclikc', index, item)
...
onMounted(() => {
  ...
  console.log(selectedMenu.value, currentIndex.value)
})
...
<template>
  <div class="fixed  bg-[#FFFFFF]   !shadow-header !px-[24px] h-full rounded-r-[100px]">
    <div class="navbar-items  max-w-max !py-[16px]">
      <div class="navbar-items__menu  !px-[12px] !mx-[12px]">
        <router-link to="/">
      ...
      <div class="navbar-items__menu !px-[12px] !mx-[12px]">
        ...
        <div class="navbar-items__menu-items">
          <div v-for="(list, index2) in selectedMenu?.children" :key="index2" class="navbar-items__menu-item"
               :class="{_active: list.isOpen || (currentIndex === index2 && list.route)}"
      ...
      <div class="navbar-items__divider"/>
      <div class="navbar-items__form">
        <div v-if="route.params.type == 'delivery'" class="grid grid-cols-1 gap-4 !p-[16px]">
    ...
    <div
        class="!hidden bg-[#FFFFFF] rounded-[100px] flex1 !shadow-header !py-[12px] !px-[32px]">
          ...
          >
            <div class="flex1">
              <span :class="list.isOpen ? 'text-[#000]' : ''">{{ list.title }} <span
                  ...
                  route.name == 'transport-repair-room-id-id2' ||
                  route.name == 'transport-repair-rooms-id' || route.name == 'service-keeping'  ||
                  route.name == 'transport-repair'  || route.name == 'transport-rental-service-id'  || route.name == 'transport-rental-service-id-id2')">({{
