...
<template>
  <Form
      ...
      :validation-schema="transportTransferSchema"
  ...
  >
    ...
    <div
      ...
      <Field as="div" :class="{
              ...
              }" name="details.transport_count" class="formItem dark:!bg-zinc-700 flex flex-col">
          ...
          <Select :loading="isLoading" :model-value="selectedTransports"
            ...
            <template #value="slotProps">
              <div v-if="slotProps.value" class="flex items-center !bg-transparent">
                <img v-if="slotProps.value.icon" :alt="slotProps.value.name"
            ...
            <template #option="slotProps">
              <div class="flex items-center grow">
                <img v-if="slotProps.option.icon" :alt="slotProps.option.name"
