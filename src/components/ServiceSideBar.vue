...
} from '@/components/form-elements/schema'
    ...
    marker: {
      ...
      callback: async (e) => {
        await getGeoObject({cord: e.coordinates}).then(res => {
          ...
          isLocationChanging.value = false
        })
      }
    }
  }, name)
  isLocationChanging.value = true
  ...
  <div class="bg-[#FFFFFF] h-[100vh]"
    ...
    <div class="navbar-items relative h-[100vh]  max-w-max ">
      ...
      >
        ...
        <Form
            v-slot="{values}"
            ref="mainForm" as="div" :validation-schema="deliverySchema"
        ...
        >
          ...
          >
            <div>
              ...
              <RadioItem as="div" name="type" v-for="item in cargoTypes" :key="item.label" :item="item"/>
              ...
              <RadioItem as="div" name="type" v-for="item in loadTypes" :key="item.label" :item="item"/>
